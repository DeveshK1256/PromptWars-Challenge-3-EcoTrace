import { ECO_CONFIG } from "./config.js?v=firebase-config-22";
import { appState, clamp, formatKg, onUserReady, setButtonBusy, showToast } from "./app.js?v=firebase-config-22";
import { ecoService } from "./firebase.js?v=firebase-config-22";
import { getPersonalizedTips } from "./gemini.js?v=firebase-config-22";
