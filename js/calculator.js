import { ECO_CONFIG } from "./config.js?v=firebase-config-27";
import { appState, clamp, formatKg, onUserReady, setButtonBusy, showToast } from "./app.js?v=firebase-config-27";
import { ecoService } from "./firebase.js?v=firebase-config-27";
import { getPersonalizedTips } from "./gemini.js?v=firebase-config-27";
