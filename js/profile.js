 ...
 */
import { BADGES } from "./data.js?v=firebase-config-35";
import { appState, formatDate, formatKg, onUserReady, setButtonBusy, showToast } from "./app.js?v=firebase-config-35";
